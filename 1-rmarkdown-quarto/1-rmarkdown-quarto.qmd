...
usethis::use_course("https://bit.ly/cincinnati-exercises")
```
...
```r
pkg_list <- c(
  "tidyverse", "gt", "ggthemes", "palmerpenguins", 
  "quarto", "here", "usethis"
  )
install.packages(pkg_list)
```

**3. Exercises:** Download [`exercises.zip`](exercises.zip) at and unzip it on your Desktop or somewhere you can easily locate on your computer.
